...
public class ConsoleScreen extends javax.swing.JFrame {
...
// حتى يتم تحديث الواجهة بشكل صحيح بعد تهيئة الشاشةومايصير لخبطة
        ...
        consoleTable.getTableHeader().setBackground(new Color(204, 204, 255, 255));
        consoleTable.getTableHeader().setFont(new Font("Segoe UI", Font.BOLD, 13));
        ...
        consoleTable.setModel(new javax.swing.table.DefaultTableModel(
                new Object[][]{},
                new String[]{
    ...
    private void initComponents() {
        ...
        consoleTable = new javax.swing.JTable();
        ...
        jLabel3.setText("Console Management");
        jPanel3.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 30, 260, -1));

        jLabel4.setBackground(new java.awt.Color(255, 255, 255));
        jLabel4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("Manage all playstation consoles in inventory");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 60, 290, -1));
        ...
        consoleTable.setBackground(new java.awt.Color(255, 255, 255));
        consoleTable.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        consoleTable.setForeground(new java.awt.Color(0, 0, 0));
        consoleTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        consoleTable.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        consoleTable.setRowHeight(200);
        jScrollPane1.setViewportView(consoleTable);
        if (consoleTable.getColumnModel().getColumnCount() > 0) {
            consoleTable.getColumnModel().getColumn(0).setPreferredWidth(100);
            consoleTable.getColumnModel().getColumn(4).setPreferredWidth(10);
        }
    ...
    private void addnewitemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addnewitemActionPerformed
        AddScreen add = new AddScreen(this, true,"CONSOLE");
        add.setVisible(true);
...
//نجيب بيانات الصف الي اختارو الشخص  وبعدها نفتح شاشه ال ادد
        int id = Integer.parseInt(consoleTable.getValueAt(row, 5).toString());
        String name = consoleTable.getValueAt(row, 1).toString();
        String model = consoleTable.getValueAt(row, 2).toString();
        double price = Double.parseDouble(consoleTable.getValueAt(row, 3).toString());
        int stock = Integer.parseInt(consoleTable.getValueAt(row, 4).toString());
        ...
        loadConsoleTable();    }//GEN-LAST:event_editActionPerformed
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            int id = Integer.parseInt(consoleTable.getValueAt(selectedRow, 5).toString());
//نتاكد من المستخدم اذا هوه ع الاكيد بدو يحذف
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ConsoleScreen().setVisible(true));

    }

    public void loadConsoleTable() {

        try {

            con = Connect.connect();

            String sql = "SELECT * FROM PRODUCT WHERE TYPE='CONSOLE'";
            ...
            DefaultTableModel model
                    = (DefaultTableModel) consoleTable.getModel();
    ...
    public javax.swing.JTable consoleTable;
